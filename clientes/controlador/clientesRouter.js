  ...
  router.post('/', (req, res) => {
    ...
    const { id,cedula,direccion,email,nombre,telefono,municipio_id } = req.body;

    const dato = {  id: id, cedula: cedula, direccion: direccion, email: email, nombre: nombre, telefono: telefono, municipio_id: municipio_id  };
